...
//
//     final dictonaryModel = dictonaryModelFromJson(jsonString);

import 'dart:convert';

DictonaryModel dictonaryModelFromJson(String str) =>
    DictonaryModel.fromJson(json.decode(str));

String dictonaryModelToJson(DictonaryModel data) => json.encode(data.toJson());
...
class DictonaryModel {
  ...
  factory DictonaryModel.fromJson(Map<String, dynamic> json) => DictonaryModel(
        word: json["word"],
